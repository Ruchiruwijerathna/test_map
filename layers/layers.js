...
lyr_ESRIOcean_0.setVisible(true);lyr_SriLankaDistricts_1.setVisible(true);lyr_SriLankaWaterways_2.setVisible(true);lyr_SriLankaRoads_3.setVisible(true);
var layersList = [lyr_ESRIOcean_0,lyr_SriLankaDistricts_1,lyr_SriLankaWaterways_2,lyr_SriLankaRoads_3];
...
lyr_SriLankaWaterways_2.set('fieldLabels', {'name': 'no label', 'name_en': 'inline label - always visible', 'waterway': 'no label', 'covered': 'no label', 'width': 'no label', 'depth': 'no label', 'layer': 'no label', 'blockage': 'no label', 'tunnel': 'no label', 'natural': 'no label', 'water': 'no label', 'source': 'no label', 'name_si': 'no label', 'name_ta': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', });
lyr_SriLankaRoads_3.set('fieldLabels', {'name': 'inline label - always visible', 'name_en': 'no label', 'highway': 'no label', 'surface': 'no label', 'smoothness': 'no label', 'width': 'no label', 'lanes': 'no label', 'oneway': 'no label', 'bridge': 'no label', 'layer': 'no label', 'source': 'no label', 'name_si': 'no label', 'name_ta': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', });
